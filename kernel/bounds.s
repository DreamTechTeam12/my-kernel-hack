...
# -imultiarch x86_64-linux-gnu -D __KERNEL__ -D KBUILD_MODFILE="./bounds"
# -D KBUILD_BASENAME="bounds" -D KBUILD_MODNAME="bounds"
# -D __KBUILD_MODNAME=bounds -include ./include/linux/compiler-version.h
# -include ./include/linux/kconfig.h
# -include ./include/linux/compiler_types.h -MMD kernel/.bounds.s.d
# kernel/bounds.c -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -mno-avx
# -mno-sse4a -m64 -mno-80387 -mno-fp-ret-in-387
# -mpreferred-stack-boundary=3 -mskip-rax-setup -march=x86-64
# -mtune=generic -mno-red-zone -mcmodel=kernel
# -mstack-protector-guard-reg=gs
# -mstack-protector-guard-symbol=__ref_stack_chk_guard
# -mindirect-branch=thunk-extern -mindirect-branch-register
# -mfunction-return=thunk-extern -auxbase-strip kernel/bounds.s -O2 -Werror
